...
var fs = require('fs')
  ...
  , utils = require('./utils')
  , debug = require('debug')('witty');


/**
 * `Witty` constructor.
 *
 * A default `Witty` singleton is exported via the module.  Applications
 ...
 *
 * Witty provides support for content negotiation, allowing a single route
 ...
 *
 * By default, Witty looks for template files using a convention of
 ...
 *
 * To facilitate mapping models to controllers, Witty introspects models
 ...
 * should be registered with Witty to provide the necessary introspection
 * logic.
 *
 * @param {Module} store
 * @api public
 ...
 * a specific controller and action in this Witty appliction.  This is
 ...
 *
 *     this.use(witty.invoke());
 *
 * If you are mounting multiple Witty applications in a single server, a
 ...
 *
 * Controller's are auto-required by Witty.  The value exported by the
 ...
 *
 * Witty uses an MVC-style router, where routes map from a URL pattern to
...
/**
 * Boot `Witty` application.
 *
 * Witty builds on Express, providing a set of conventions for how to
 * organize code and resources on the file system as well as an MVC architecture
 * for structuring code.
 *
 * When booting a Witty application, the file system conventions are used
