...
/**
 * Create Witty application at `path`.
 *
 * @param {String} path
 * @api private
 */
exports = module.exports = function create(path) {
  console.log('creating Witty application at : ' + path);
...
var mainTemplate = [
  ...
  , '  <body>'
  , '    <h1><%= title %></h1>'
  , '    <p>Welcome aboard! Visit <a href="http://maglevjs.org/">maglevjs.org</a> for details.</p>'
  , '  </body>'
  , '</html>'
].join(eol);
...
var allEnvironments = [
  ...
  , '  // Warn of version mismatch between global "witty" binary and local installation'
  , '  // of Witty.'
...
var viewsInitializer = [
  ...
  , ''
  , '  // Override default template extension.  By default, Witty finds'
